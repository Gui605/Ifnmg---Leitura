...
router.post('/:postId', authMiddleware_1.middlewareAutenticacao, rateLimiter_1.limitadorEngajamento, (0, validate_middleware_1.validate)({
    params: ParamsSchema,
    body: denuncia_types_1.DenunciaCreateSchema
}), denuncias_controller_1.default.criar);
