...
router.post('/registrar', rateLimiter_1.limitadorRegistro, (0, validate_middleware_1.validate)(auth_types_1.RegistrarSchema), auth_controller_1.default.registrar);
...
router.post('/logar', rateLimiter_1.limitadorLogin, (0, validate_middleware_1.validate)(auth_types_1.LoginSchema), auth_controller_1.default.logar);
// --- Recuperação de Senha ---
router.post('/solicitar-recuperacao', rateLimiter_1.limitadorRegistro, (0, validate_middleware_1.validate)(auth_types_1.SolicitarRecuperacaoSchema), auth_controller_1.default.solicitarRecuperacao);
router.post('/redefinir-senha', rateLimiter_1.limitadorRegistro, (0, validate_middleware_1.validate)(auth_types_1.RedefinirSenhaSchema), auth_controller_1.default.redefinirSenha);
