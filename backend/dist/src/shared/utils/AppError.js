...
class AppError extends Error {
    constructor(message, statusCode, errorCode) {
        ...
        // Garante que o rastro do erro (stack trace) aponte para onde o AppError foi instanciado
        Error.captureStackTrace(this, this.constructor);
    }
    //  Atalhos que injetam automaticamente o código de erro em português
